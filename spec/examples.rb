...
module CICTL
  EXAMPLES = [
    {file: "zephir_full_20221231_vufind.json.gz",
     ids: %w[000130709 000130743 000133681 000134961 000135338
       ...
       000165447],
     type: :monthly},
    {file: "zephir_upd_20230101.json.gz",
     ids: %w[000009336 000014526],
     type: :daily},
    {file: "zephir_upd_20230101_delete.txt",
     ids: %w[000130709],
     type: :delete},
    {file: "zephir_upd_20230102.json.gz",
     ids: %w[000048849 000014526 000051247 000051671],
     type: :daily},
    {file: "zephir_upd_20230102_delete.txt",
     ids: %w[000009336],
     type: :delete},
    {file: "zephir_upd_20230103.json.gz",
     ids: %w[000055197 000055313 000055797 000056190 000057209
       000058181 000058183 000058228],
     type: :daily},
    {file: "zephir_upd_20230103_delete.txt",
     ids: %w[000048849],
     type: :delete}
  ].freeze
end
