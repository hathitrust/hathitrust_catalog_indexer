...
module AvailabilitynMapHT
  TESTS = {
    ...
    "pdus" => [HathiTrust::Constants::FT], # 9
    ...
    "icus" => [HathiTrust::Constants::SO], # 19
  ...
  RSpec.describe AvailabilitynMapHT do
    let(:map) {
      rb_file = File.expand_path("../../lib/translation_maps/ht/availability_map_ht.rb", __dir__)
