...
"ContentType.BookSeries" => "Journal",
...
"ContentType.ComputerDocument" => nil,
...
"ContentType.Newspaper" => ["Journal", "Newspaper"],
"ContentType.Pamphlet" => "Visual Materials",
"ContentType.Periodical" => ["Journal", "Periodical"],
...
"ContentType.Serial" => "Journal",
"ContentType.SerialComponentPart" => "Journal",
"ContentType.SerialIntegratingResource" => "Journal",
...
"MediaType.Kit" => "Kit",
"MediaType.LooseLeaf" => ["Journal", "Looseleaf"],
"MediaType.Map" => "Map",
...
"FormOfItem.ElectronicDirect" => nil,
"FormOfItem.Electronic" => nil,
"FormOfItem.Print" => "Print",

#CombinedType
"CombinedType.Electronic Resource" => "Electronic Resource",
