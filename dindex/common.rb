...
to_field 'oclc_mn_s', oclcnum('035a:035z')

sdr_pattern = /^sdr-/
to_field 'sdrnum_ms_s' do |record, acc|
...
to_field 'issn_mn_s', extract_marc('022a:022l:022m:022y:022z:247x')
to_field 'isn_related_mn_s', extract_marc("400x:410x:411x:440x:490x:500x:510x:534xz:556z:581z:700x:710x:711x:730x:760x:762x:765xz:767xz:770xz:772x:773xz:774xz:775xz:776xz:777x:780xz:785xz:786xz:787xz")


  
to_field 'sudoc_ms_s', extract_marc('086az')
to_field "lccn_ms_s", extract_marc('010a')
to_field 'rptnum_me_s', extract_marc('088a')
...
to_field 'mainauthor_mt_s', extract_marc('100abcd:110abcd:111abc')
to_field 'mainauthor_role_mt_s', extract_marc('100e:110e:111e', :trim_punctuation => true)
...
to_field "author_sort_e", extract_marc_unless("100abcd:110abcd:111abc:110ab:700abcd:710ab:711ab",skipWaSeSS, :first=>true) do |rec, acc, context|
...
# Sortable title
to_field "title_sort_e", marc_sortable_title
...
to_field "title_top_mtmax", extract_marc("240adfghklmnoprs0:245abfghknps:247abfghknps:111acdefgjklnpqtu04:130adfghklmnoprst0")
to_field "title_rest_mtmax", extract_marc("210ab:222ab:242abhnpy:243adfghklmnoprs:246abdenp:247abdenp:700fghjklmnoprstx03:710fghklmnoprstx03:711acdefghjklnpqstux034:730adfghklmnoprstx03:740ahnp:765st:767st:770st:772st:773st:775st:776st:777st:780st:785st:786st:787st:830adfghklmnoprstv:440anpvx:490avx:505t")
to_field "series_mtmax_s", extract_marc("440ap:800abcdfpqt:830ap")
to_field "series2_mtmax", extract_marc("490a")
#
...
to_field "topic_ms_s", extract_marc_unless(%w(
...
################################
#
to_field "genre_mes_s", extract_marc('655ab')


# Look into using Traject default geo field
to_field "geographic_mt_s" do |record, acc|
